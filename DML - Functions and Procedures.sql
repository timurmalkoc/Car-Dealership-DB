...
AS $$
BEGIN 
	INSERT INTO invoice(customer_id, salesperson_id, car_serial_num, invoice_type, ticket_id)
	VALUES (customer_id, salesperson_id, car_serial_num, invoice_type, ticket_id);
END
$$;
